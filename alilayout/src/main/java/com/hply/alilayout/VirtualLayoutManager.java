...
import com.hply.alilayout.layout.BaseLayoutHelper;
import com.hply.alilayout.layout.DefaultLayoutHelper;
import com.hply.alilayout.layout.FixAreaAdjuster;
import com.hply.alilayout.layout.FixAreaLayoutHelper;
...
public class VirtualLayoutManager extends ExposeLinearLayoutManagerEx implements LayoutManagerHelper {
    ...
    @Override
    protected void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LayoutState layoutState, com.hply.alilayout.layout.LayoutChunkResult result) {
    ...
    public static class LayoutStateWrapper {
        ...
        /**
         * This {@link #layoutChunk(RecyclerView.Recycler, RecyclerView.State, LayoutState, com.hply.alilayout.layout.LayoutChunkResult)} pass is in layouting or scrolling
         */
    ...
    public void onMeasure(RecyclerView.Recycler recycler, RecyclerView.State state, int widthSpec, int heightSpec) {
        ...
        if (getOrientation() == VERTICAL) {
            super.onMeasure(recycler, state, widthSpec, View.MeasureSpec.makeMeasureSpec(Math.min(measuredSize,1073147823), View.MeasureSpec.AT_MOST));
        } else {
            super.onMeasure(recycler, state, View.MeasureSpec.makeMeasureSpec(Math.min(measuredSize,1073147823), View.MeasureSpec.AT_MOST), heightSpec);
        }
    }
}
