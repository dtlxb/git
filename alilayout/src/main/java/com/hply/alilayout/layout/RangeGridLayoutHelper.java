...
import com.hply.alilayout.layout.GridLayoutHelper.DefaultSpanSizeLookup;
import com.hply.alilayout.layout.GridLayoutHelper.SpanSizeLookup;
...
public class RangeGridLayoutHelper extends BaseLayoutHelper {
    ...
    public void layoutViews(RecyclerView.Recycler recycler, RecyclerView.State state, LayoutStateWrapper layoutState, LayoutChunkResult result, LayoutManagerHelper helper) {
         ...
         * see {@link com.hply.alilayout.ExposeLinearLayoutManagerEx#updateLayoutStateExpose(int, int, boolean, State)},
         ...
         * see {@link com.hply.alilayout.ExposeLinearLayoutManagerEx#updateAnchorInfoForLayoutExpose(State, AnchorInfo)},
