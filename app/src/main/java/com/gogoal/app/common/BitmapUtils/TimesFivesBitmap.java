...
public class TimesFivesBitmap {
    ...
    private void drawLines(Canvas canvas) {
        ...
        paintShadow.setColor(ContextCompat.getColor(MyApp.mContext, R.color.time_shadow_color));
        ...
        for (int i = 0; i < timesList.size(); i++) {
            ...
            if (!isTimes) {
                ...
                paintTop.setColor(ContextCompat.getColor(MyApp.mContext, R.color.time_prive));
                canvas.drawPath(time_line_path, paintTop);
                paintTop.setColor(ContextCompat.getColor(MyApp.mContext,R.color.time_avg_prive));
