package com.gogoal.app.ui.index;
...
public class SuspendedDecoration extends RecyclerView.ItemDecoration {
    ...
    public SuspendedDecoration setColorTitleFont(int colorTitleFont) {
        COLOR_TITLE_FONT = colorTitleFont;
        return this;
    }

    public SuspendedDecoration setTitleFontSize(int mTitleFontSize) {
        mPaint.setTextSize(mTitleFontSize);
        return this;
    }

    public SuspendedDecoration setmDatas(List<? extends ISuspensionInterface> mDatas) {
        this.mDatas = mDatas;
        return this;
    }
    ...
    public SuspendedDecoration setHeaderViewCount(int headerViewCount) {
...
//                KLog.e("onDrawOver() called with: c = [" + child.getTop());//当getTop开始变负，它的绝对值，是第一个可见的Item移出屏幕的距离，
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (position > -1) {
            ...
            //等于0肯定要有title的,
            // add 考虑到headerView 等于0 也不应该有title
            // add 通过接口里的isShowSuspension() 方法，先过滤掉不想显示悬停的item
