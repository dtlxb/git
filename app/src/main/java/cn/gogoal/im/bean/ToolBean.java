...
public class ToolBean {
    ...
    public List<ToolData> getData() {
        return data;
    }

    public void setData(List<ToolData> data) {
        this.data = data;
    }
}
