...
import cn.gogoal.im.ui.widget.BaseDialog;
...
public class MyStockTopDialog extends BaseDialog {
    ...
    public void bindView(View v) {
        View dialogSpace=v.findViewById(R.id.dialog_space);
        AppDevice.setViewWidth$Height(dialogSpace,
                ViewGroup.LayoutParams.MATCH_PARENT,
                getResources().getDimensionPixelOffset(R.dimen.titlebar_size));
