...
public class AnimationUtils {
    ...
    public RotateAnimation setLoadingAnime(View refreshBtn, @DrawableRes int rotateImage) {
        refreshBtn.setBackgroundResource(rotateImage);
    ...
    public void cancleLoadingAnime(Animation animation,View refreshBtn, @DrawableRes int placeholderImage) {
        if (animation != null) {
            animation.cancel();
            refreshBtn.setBackgroundResource(placeholderImage);
