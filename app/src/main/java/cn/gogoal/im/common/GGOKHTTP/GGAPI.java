...
public class GGAPI {
    ...
    private static final String APP_KEY = "wxeAauUegQYPsOm";
    private static final String APP_SECRET = "QQU7zlyFvDiHzNg7cp8dfz8aRCpg2sqw";

    //沙盒环境2
//  private static final String Native_API = "http://gapi.go-goal.cn";
//  private static final String APP_KEY = "wxeAauUegQYPsOm";
//  private static final String APP_SECRET = "QQU7zlyFvDiHzNg7cp8dfz8aRCpg2sqw";
