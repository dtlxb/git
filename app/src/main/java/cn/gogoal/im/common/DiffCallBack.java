...
//    private List<ToolData.Tool> mOldDatas, mNewDatas;//看名字
//
//    public DiffCallBack(List<ToolData.Tool> mOldDatas, List<ToolData.Tool> mNewDatas) {
...
//        ToolData.Tool beanOld = mOldDatas.get(oldItemPosition);
//        ToolData.Tool beanNew = mNewDatas.get(newItemPosition);
