...
public class QuickIndexBar extends View {
    ...
    public void setFlag(TextView tvFlag){
        this.tvFlag=tvFlag;
    }
    ...
    public QuickIndexBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPaint.setColor(ContextCompat.getColor(context,R.color.index_bar_bg));
