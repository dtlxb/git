...
public class XLayout extends FrameLayout {
    ...
    public XLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void build() {
        ...
        errorPage.setBackgroundColor(ContextCompat.getColor(mContext, mConfig.backgroundColor));
        emptyPage.setBackgroundColor(ContextCompat.getColor(mContext, mConfig.backgroundColor));
        networkPage.setBackgroundColor(ContextCompat.getColor(mContext, mConfig.backgroundColor));

        errorText = UIHelper.findViewById(errorPage, R.id.error_text);
        emptyText = UIHelper.findViewById(emptyPage, R.id.empty_text);
        networkText = UIHelper.findViewById(networkPage, R.id.no_network_text);

        errorImg = UIHelper.findViewById(errorPage, R.id.error_img);
        ...
        errorText.setTextColor(ContextCompat.getColor(mContext, mConfig.tipTextColor));
        emptyText.setTextColor(ContextCompat.getColor(mContext, mConfig.tipTextColor));
        networkText.setTextColor(ContextCompat.getColor(mContext, mConfig.tipTextColor));
        ...
        errorReloadBtn.setTextColor(ContextCompat.getColor(mContext, mConfig.buttonTextColor));
        networkReloadBtn.setTextColor(ContextCompat.getColor(mContext, mConfig.buttonTextColor));

        if (mConfig.buttonHeight != -1) {

            errorReloadBtn.setHeight(AppDevice.dp2px(mContext, mConfig.buttonHeight));
            networkReloadBtn.setHeight(AppDevice.dp2px(mContext, mConfig.buttonHeight));
        }
        if (mConfig.buttonWidth != -1) {

            errorReloadBtn.setWidth(AppDevice.dp2px(mContext, mConfig.buttonWidth));
            networkReloadBtn.setWidth(AppDevice.dp2px(mContext, mConfig.buttonWidth));
        }
     ...
     * @return
     */
    public XLayout setErrorText(String text) {
     ...
     * @return
     */
    public XLayout setNoNetworkText(String text) {
     ...
     * @return
     */
    public XLayout setEmptyImage(@DrawableRes int id) {
     ...
     * @return
     */
    public XLayout setErrorImage(@DrawableRes int id) {
     ...
     * @return
     */
    public XLayout setNoNetworkImage(@DrawableRes int id) {
     ...
     * @return
     */
    public XLayout setEmptyTextSize(int sp) {
     ...
     * @return
     */
    public XLayout setErrorTextSize(int sp) {
     ...
     * @return
     */
    public XLayout setNoNetworkTextSize(int sp) {
     ...
     * @return
     */
    public XLayout setEmptyImageVisible(boolean bool) {
     ...
     * @return
     */
    public XLayout setErrorImageVisible(boolean bool) {
     ...
     * @return
     */
    public XLayout setNoNetworkImageVisible(boolean bool) {
     ...
     * @return
     */
    public XLayout setReloadButtonText(@NonNull String text) {
     ...
     * @return
     */
    public XLayout setReloadButtonTextSize(int sp) {
     ...
     * @return
     */
    public XLayout setReloadButtonTextColor(@ColorRes int id) {
     ...
     * @return
     */
    public XLayout setReloadButtonBackgroundResource(@DrawableRes int id) {
     ...
     * @return
     */
    public XLayout setOnReloadListener(OnReloadListener listener) {
     ...
     * @return
     */
    public XLayout setLoadingPage(View view) {
     ...
     * @return
     */
    public XLayout setLoadingPage(@LayoutRes int id) {
     ...
     * @return
     */
    public XLayout setDefineBackgroundColor(@ColorRes int color) {

        if (defineLoadingPage == null) {
            loadingPage.setBackgroundColor(ContextCompat.getColor(mContext, color));
        } else {
            defineLoadingPage.setBackgroundColor(ContextCompat.getColor(mContext, color));
        }
        errorPage.setBackgroundColor(ContextCompat.getColor(mContext, color));
        emptyPage.setBackgroundColor(ContextCompat.getColor(mContext, color));
        networkPage.setBackgroundColor(ContextCompat.getColor(mContext, color));
        return this;
    }
    ...
    public static class Config {
        ...
        int emptyImgId = R.mipmap.img_no_data;
        ...
        int tipTextColor = R.color.index_bar_bg;
        int buttonTextColor = R.color.index_bar_text;
        int buttonWidth = -1;
        int buttonHeight = -1;
