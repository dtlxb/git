...
public class ColorPalette extends LinearLayout{
    ...
    public ColorPalette(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //ColorPicker
        LinearLayout.LayoutParams p1=new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,0,1);
        //SeekbarLayout
        ...
        //ColorLayout
        LinearLayout.LayoutParams p3=new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 100);
        //ColorBoardLayout
        LinearLayout.LayoutParams p4=new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);

        LinearLayout.LayoutParams p33=new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT,1);
        ...
        //SeekbarText
        LinearLayout.LayoutParams px=new LinearLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT);
        //SeekBar
        LinearLayout.LayoutParams pppp=new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT,1);
    ...
    private void initEvent() {
        ...
        lastColor.setOnClickListener(new View.OnClickListener() {
            @Override
