 ...
 * description :跳过
 */
public class SkipProgressView extends TextView {
    //TODO 圆实心的颜色
    ...
    public SkipProgressView(Context context) {
        super(context);
        init();
    }
     ...
     */
    public SkipProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.SkipProgressView);
        if (typedArray != null) {
            //TODO 圆实心的颜色属性
            circSolidColor = typedArray.getColor(R.styleable.SkipProgressView_circSolidColor, Color.parseColor("#66000000"));

            //TODO 园边框颜色属性
            circFrameColor = typedArray.getColor(R.styleable.SkipProgressView_circFrameColor, Color.TRANSPARENT);

            //TODO 文字颜色属性
            textColor = typedArray.getColor(R.styleable.SkipProgressView_textColor,Color.WHITE);

            //TODO 进度条颜色属性
            progressColor = typedArray.getColor(R.styleable.SkipProgressView_progressColor,
    ...
    public void init() {
        ...
        mBounds = new Rect();
        mArcRectF = new RectF();
        progressWidth= AppDevice.dp2px(getContext(),2);
    }
