...
public class SelectorButton extends AppCompatButton {
    ...
    private int mUnableTextColor = 0xff333333;
    ...
    //background 背景
    private int mNormalBackgroundColor = 0xfff0f0f0;
    private int mPressedBackgroundColor = 0xff999999;
    private int mUnableBackgroundColor = 0xaa999999;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.SelectorButton);
        ...
        mNormalTextColor = a.getColor(R.styleable.SelectorButton_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.SelectorButton_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.SelectorButton_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //设置动画时长
        mDuration = a.getInteger(R.styleable.SelectorButton_animationDuration, mDuration);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.SelectorButton_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.SelectorButton_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.SelectorButton_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.SelectorButton_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.SelectorButton_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.SelectorButton_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.SelectorButton_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.SelectorButton_unableStrokeColor, 0);
        setStroke();
