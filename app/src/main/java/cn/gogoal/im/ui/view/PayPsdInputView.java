...
public class PayPsdInputView extends AppCompatEditText{
    ...
    private void getAtt(AttributeSet attrs) {
        ...
        maxCount = typedArray.getInt(R.styleable.PayPsdInputView_ppi_maxCount, maxCount);
        circleColor = typedArray.getColor(R.styleable.PayPsdInputView_ppi_circleColor, circleColor);
        bottomLineColor = typedArray.getColor(R.styleable.PayPsdInputView_ppi_bottomLineColor, bottomLineColor);
        radius = typedArray.getDimensionPixelOffset(R.styleable.PayPsdInputView_ppi_radius, radius);

        divideLineWidth = typedArray.getDimensionPixelSize(R.styleable.PayPsdInputView_ppi_divideLineWidth, divideLineWidth);
        divideLineColor = typedArray.getColor(R.styleable.PayPsdInputView_ppi_divideLineColor, divideLineColor);
        psdType = typedArray.getInt(R.styleable.PayPsdInputView_ppi_psdType, psdType);
        rectAngle = typedArray.getDimensionPixelOffset(R.styleable.PayPsdInputView_ppi_rectAngle, rectAngle);
