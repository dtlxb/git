...
public class BadgeView extends View implements Badge {
    ...
    private void init() {
        ...
        mBadgeTextSize = AppDevice.dp2px(getContext(), 11);
        mBadgePadding = AppDevice.dp2px(getContext(), 5);
        mBadgeNumber = 0;
        mBadgeGravity = Gravity.END | Gravity.TOP;
        mGravityOffsetX = AppDevice.dp2px(getContext(), 5);
        mGravityOffsetY = AppDevice.dp2px(getContext(), 5);
        mFinalDragDistance = AppDevice.dp2px(getContext(), 90);
        mShowShadow = true;
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                ...
                if (mDraggable && event.getPointerId(event.getActionIndex()) == 0
                    ...
                    mDefalutRadius = AppDevice.dp2px(getContext(), 7);
    ...
    protected Bitmap createBadgeBitmap() {
        Bitmap bitmap = Bitmap.createBitmap((int) mBadgeBackgroundRect.width() + AppDevice.dp2px(getContext(), 3),
                (int) mBadgeBackgroundRect.height() + AppDevice.dp2px(getContext(), 3), Bitmap.Config.ARGB_8888);
    ...
    private void showShadowImp(boolean showShadow) {
        int x = AppDevice.dp2px(getContext(), 1);
        int y = AppDevice.dp2px(getContext(), 1.5f);
        switch (mDragQuadrant) {
            case 1:
                x = AppDevice.dp2px(getContext(), 1);
                y = AppDevice.dp2px(getContext(), -1.5f);
                break;
            case 2:
                x = AppDevice.dp2px(getContext(), -1);
                y = AppDevice.dp2px(getContext(), -1.5f);
        ...
        mBadgeBackgroundPaint.setShadowLayer(showShadow ? AppDevice.dp2px(getContext(), 2f)
                : 0, x, y, 0x33000000);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBadgeText != null) {
            ...
            if (mDraggable && mDragging) {
                ...
                showShadowImp(mShowShadow);
                if (mDragOutOfRange = startCircleRadius < AppDevice.dp2px(getContext(), 1.5f)) {
    ...
    public Badge setBadgeTextSize(float size, boolean isSpValue) {
        mBadgeTextSize = isSpValue ? AppDevice.dp2px(getContext(), size) : size;
        invalidate();
        return this;
    }
    ...
    public float getBadgeTextSize(boolean isSpValue) {
        return isSpValue ? AppDevice.px2dp(getContext(), mBadgeTextSize) : mBadgeTextSize;
    }

    @Override
    public Badge setBadgePadding(float padding, boolean isDpValue) {
        mBadgePadding = isDpValue ? AppDevice.dp2px(getContext(), padding) : padding;
        invalidate();
        return this;
    }
    ...
    public float getBadgePadding(boolean isDpValue) {
        return isDpValue ? AppDevice.px2dp(getContext(), mBadgePadding) : mBadgePadding;
    }
    ...
    public Badge setGravityOffset(float offsetX, float offsetY, boolean isDpValue) {
        mGravityOffsetX = isDpValue ? AppDevice.dp2px(getContext(), offsetX) : offsetX;
        mGravityOffsetY = isDpValue ? AppDevice.dp2px(getContext(), offsetY) : offsetY;
        invalidate();
        return this;
    }
    ...
    public float getGravityOffsetX(boolean isDpValue) {
        return isDpValue ? AppDevice.px2dp(getContext(), mGravityOffsetX) : mGravityOffsetX;
    }

    @Override
    public float getGravityOffsetY(boolean isDpValue) {
        return isDpValue ? AppDevice.px2dp(getContext(), mGravityOffsetY) : mGravityOffsetY;
    }
