...
public class PasswordView extends AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        rectAngle= AppDevice.dp2px(context,4);
    }

    private void getAtt(Context mContext,AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.PasswordView);
        maxCount = typedArray.getInt(R.styleable.PasswordView_maxCount, maxCount);
        circleColor = typedArray.getColor(R.styleable.PasswordView_circleColor, circleColor);
        bottomLineColor = typedArray.getColor(R.styleable.PasswordView_bottomLineColor, bottomLineColor);
        radius = typedArray.getDimensionPixelOffset(R.styleable.PasswordView_dotRadius, radius);

        divideLineWidth = typedArray.getDimensionPixelSize(R.styleable.PasswordView_divideLineWidth, divideLineWidth);
        divideLineColor = typedArray.getColor(R.styleable.PasswordView_divideLineColor, divideLineColor);
        psdType = typedArray.getInt(R.styleable.PasswordView_psdType, psdType);
        rectAngle = typedArray.getDimensionPixelOffset(R.styleable.PasswordView_rectAngle, rectAngle);
