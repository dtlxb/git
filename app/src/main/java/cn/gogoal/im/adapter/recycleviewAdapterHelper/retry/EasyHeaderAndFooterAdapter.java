 ...
 * Staff_id 1375
 * phone 18930640263
 * description :头部尾部适配器(RecyclerView专用)
 * <p>
 ...
 * <p>
 * 如：
 * EasyAdapterForRecyclerView adapter = new EasyAdapterForRecyclerView();
 * recyclerView.setAdatper(adapter.getHeaderAndFooterAdapter());
 */
public class EasyHeaderAndFooterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public EasyHeaderAndFooterAdapter(RecyclerView.Adapter innerAdapter) {
