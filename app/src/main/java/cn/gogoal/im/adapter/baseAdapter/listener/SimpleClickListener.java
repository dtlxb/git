...
import static cn.gogoal.im.adapter.baseAdapter.CommonAdapter.EMPTY_VIEW;
import static cn.gogoal.im.adapter.baseAdapter.CommonAdapter.FOOTER_VIEW;
import static cn.gogoal.im.adapter.baseAdapter.CommonAdapter.HEADER_VIEW;
import static cn.gogoal.im.adapter.baseAdapter.CommonAdapter.LOADING_VIEW;
...
public abstract class SimpleClickListener implements RecyclerView.OnItemTouchListener {
    ...
    protected CommonAdapter baseQuickAdapter;
    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        if (recyclerView == null) {
            ...
            this.baseQuickAdapter = (CommonAdapter) recyclerView.getAdapter();
...
//                mPressedView.setPressed(true);
     ...
     */
    public abstract void onItemClick(CommonAdapter adapter, View view, int position);
     ...
     */
    public abstract void onItemLongClick(CommonAdapter adapter, View view, int position);

    public abstract void onItemChildClick(CommonAdapter adapter, View view, int position);

    public abstract void onItemChildLongClick(CommonAdapter adapter, View view, int position);
    ...
    private boolean isHeaderOrFooterPosition(int position) {
        ...
        if (baseQuickAdapter==null){
            if (recyclerView!=null){
                baseQuickAdapter= (CommonAdapter) recyclerView.getAdapter();
            }else {
                return false;
            }
        }
