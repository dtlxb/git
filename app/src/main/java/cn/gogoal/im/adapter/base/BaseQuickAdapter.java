...
import cn.gogoal.im.adapter.base.animator.AlphaInAnimation;
import cn.gogoal.im.adapter.base.animator.BaseAnimation;
import cn.gogoal.im.adapter.base.animator.ScaleInAnimation;
import cn.gogoal.im.adapter.base.animator.SimpleLoadMoreView;
import cn.gogoal.im.adapter.base.animator.SlideInBottomAnimation;
import cn.gogoal.im.adapter.base.animator.SlideInLeftAnimation;
import cn.gogoal.im.adapter.base.animator.SlideInRightAnimation;
    ...
    public int addHeaderView(View header, int index, int orientation) {
        if (mHeaderLayout == null) {
            ...
            if (orientation == LinearLayout.VERTICAL) {
                ...
                mHeaderLayout.setLayoutParams(new RecyclerView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                        ViewGroup.LayoutParams.WRAP_CONTENT));
            } else {
                mHeaderLayout.setOrientation(LinearLayout.HORIZONTAL);
                mHeaderLayout.setLayoutParams(new RecyclerView.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
    ...
    public int addFooterView(View footer, int index, int orientation) {
        if (mFooterLayout == null) {
            ...
            if (orientation == LinearLayout.VERTICAL) {
                ...
                mFooterLayout.setLayoutParams(new RecyclerView.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                        ViewGroup.LayoutParams.WRAP_CONTENT));
            } else {
                mFooterLayout.setOrientation(LinearLayout.HORIZONTAL);
                mFooterLayout.setLayoutParams(new RecyclerView.LayoutParams(
