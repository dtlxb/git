 ...
 * Desc: description
 */
public class FinancialStatementsLeftAdapter extends MyBaseAdapter {

    private ArrayList<String> titleList;
    private Context context;

    public FinancialStatementsLeftAdapter(Context context, ArrayList list) {
        super(list);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_financial_left, parent, false);
        ...
        if (position == 0) {
            holder.textTitle.setLines(1);
        } else {
            holder.textTitle.setLines(2);
        }
