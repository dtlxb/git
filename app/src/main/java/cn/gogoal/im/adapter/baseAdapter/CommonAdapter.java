...
import cn.gogoal.im.adapter.baseAdapter.animation.AlphaInAnimation;
import cn.gogoal.im.adapter.baseAdapter.animation.BaseAnimation;
import cn.gogoal.im.adapter.baseAdapter.animation.ScaleInAnimation;
import cn.gogoal.im.adapter.baseAdapter.animation.SlideInBottomAnimation;
...
public abstract class CommonAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (getOnItemClickListener() != null && baseViewHolder != null) {
                    ...
                    getOnItemClickListener().onItemClick(CommonAdapter.this, v, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
        ...
        view.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (getOnItemLongClickListener() != null && baseViewHolder != null) {
                    return getOnItemLongClickListener().onItemLongClick(CommonAdapter.this, v, baseViewHolder.getLayoutPosition() - getHeaderLayoutCount());
                }
                return false;
    ...
    /**
     * When the current adapter is empty, the CommonAdapter can display a special view
