 ...
 * Staff_id 1375
 * phone 18930640263
 * description :状态栏统配工具，解决fragmetnt中使用，以及国产手机自适应强制的沉浸式
 */
...
public class StatusBarUtil {
     ...
     * @return the immersion bar
     */
    public StatusBarUtil transparentStatusBar() {
     ...
     * @return the immersion bar
     */
    public StatusBarUtil transparentNavigationBar() {
     ...
     * @return the immersion bar
     */
    public StatusBarUtil transparentBar() {
        mBarParams.statusBarColor = Color.TRANSPARENT;
        mBarParams.navigationBarColor = Color.TRANSPARENT;
        mBarParams.navigationBarColorTem = mBarParams.navigationBarColor;
        mBarParams.fullScreen = true;
     ...
     * @return the immersion bar
     */
    public StatusBarUtil statusBarColor(@ColorRes int statusBarColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtil navigationBarColor(@ColorRes int navigationBarColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtil barColor(@ColorRes int barColor) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtil barColor(@ColorRes int barColor, @FloatRange(from = 0f, to = 1f) float barAlpha) {
        mBarParams.statusBarColor = ContextCompat.getColor(mActivity, barColor);
        mBarParams.navigationBarColor = ContextCompat.getColor(mActivity, barColor);
        mBarParams.navigationBarColorTem = mBarParams.navigationBarColor;
     ...
     * @return the immersion bar
     */
    public StatusBarUtil statusBarColorTransform(@ColorRes int statusBarColorTransform) {
        mBarParams.statusBarColorTransform = ContextCompat.getColor(mActivity, statusBarColorTransform);
        return this;
    }
     ...
     * @return the immersion bar
     */
    public StatusBarUtil navigationBarColorTransform(@ColorRes int navigationBarColorTransform) {
        mBarParams.navigationBarColorTransform = ContextCompat.getColor(mActivity, navigationBarColorTransform);
        return this;
    }
     ...
     * @return the immersion bar
     */
    public StatusBarUtil barColorTransform(@ColorRes int barColorTransform) {
        mBarParams.statusBarColorTransform = ContextCompat.getColor(mActivity, barColorTransform);
        mBarParams.navigationBarColorTransform = ContextCompat.getColor(mActivity, barColorTransform);
        return this;
    }
     ...
     */
    public StatusBarUtil setViewSupportTransformColor(View view) {
     ...
     * @return the view transform color
     */
    public StatusBarUtil setViewSupportTransformColor(View view, @ColorRes int viewColorAfterTransform) {
        mBarParams.view = view;
        mBarParams.viewColorBeforeTransform = mBarParams.statusBarColor;
     ...
     * @return the immersion bar
     */
    public StatusBarUtil setViewSupportTransformColor(View view, @ColorRes int viewColorBeforeTransform,
     ...
     * @return the immersion bar
     */
    public StatusBarUtil addViewSupportTransformColor(View view) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtil addViewSupportTransformColor(View view, @ColorRes int viewColorAfterTransform) {
        Map<Integer, Integer> map = new HashMap<>();
     ...
     * @return the immersion bar
     */
    public StatusBarUtil addViewSupportTransformColor(View view, @ColorRes int viewColorBeforeTransform,
                                                     @ColorRes int viewColorAfterTransform) {
        Map<Integer, Integer> map = new HashMap<>();
     ...
     * @return the immersion bar
     */
    public StatusBarUtil removeSupportView() {
     ...
     * @return the immersion bar
     */
    public StatusBarUtil removeSupportView(View view) {
        if (view != null) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtil removeSupportAllView() {
     ...
     * @return the immersion bar
     */
    public StatusBarUtil fullScreen(boolean isFullScreen) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtil statusBarAlpha(@FloatRange(from = 0f, to = 1f) float statusAlpha) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtil navigationBarAlpha(@FloatRange(from = 0f, to = 1f) float navigationAlpha) {
        mBarParams.navigationBarAlpha = navigationAlpha;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public StatusBarUtil barAlpha(@FloatRange(from = 0f, to = 1f) float barAlpha) {
        mBarParams.statusBarAlpha = barAlpha;
        mBarParams.navigationBarAlpha = barAlpha;
        return this;
    }
     ...
     * @return the immersion bar
     */
    public StatusBarUtil statusBarDarkFont(boolean isDarkFont) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtil hideBar(BarHide barHide) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtil fitsSystemWindows(boolean fits) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtil statusBarView(View view) {
     ...
     * @return the immersion bar
     */
    public StatusBarUtil statusBarView(@IdRes int viewId) {
